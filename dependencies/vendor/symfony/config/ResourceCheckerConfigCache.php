...
use Emoji\Vendor\Symfony\Component\Filesystem\Filesystem;
/**
 ...
 */
class ResourceCheckerConfigCache implements \Emoji\Vendor\Symfony\Component\Config\ConfigCacheInterface
{
    /**
     * @var string
     */
    ...
    public function write($content, array $metadata = null)
    {
        $mode = 0666;
        $umask = \umask();
        $filesystem = new \Emoji\Vendor\Symfony\Component\Filesystem\Filesystem();
        $filesystem->dumpFile($this->file, $content);
        try {
            $filesystem->chmod($this->file, $mode, $umask);
        } catch (\Emoji\Vendor\Symfony\Component\Filesystem\Exception\IOException $e) {
