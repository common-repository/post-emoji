...
use Emoji\Vendor\Symfony\Component\Finder\Finder;
use Emoji\Vendor\Symfony\Component\Finder\Glob;
/**
 ...
 */
class GlobResource implements \IteratorAggregate, \Emoji\Vendor\Symfony\Component\Config\Resource\SelfCheckingResourceInterface, \Serializable
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator()
    {
        ...
        if (!\class_exists(\Emoji\Vendor\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \Emoji\Vendor\Symfony\Component\Finder\Finder();
        $regex = \Emoji\Vendor\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
