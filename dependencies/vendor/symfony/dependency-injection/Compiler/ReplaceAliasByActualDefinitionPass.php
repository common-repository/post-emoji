 ...
 */
class ReplaceAliasByActualDefinitionPass extends \Emoji\Vendor\Symfony\Component\DependencyInjection\Compiler\AbstractRecursivePass
{
    ...
    public function process(\Emoji\Vendor\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($container->getAliases() as $definitionId => $target) {
            ...
            try {
                ...
                throw new \Emoji\Vendor\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('Unable to replace alias "%s" with actual definition "%s".', $definitionId, $targetId), null, $e);
            }
    ...
    {
        if ($value instanceof \Emoji\Vendor\Symfony\Component\DependencyInjection\Reference && isset($this->replacements[$referenceId = $this->container->normalizeId($value)])) {
            // Perform the replacement
            $newId = $this->replacements[$referenceId];
            $value = new \Emoji\Vendor\Symfony\Component\DependencyInjection\Reference($newId, $value->getInvalidBehavior());
