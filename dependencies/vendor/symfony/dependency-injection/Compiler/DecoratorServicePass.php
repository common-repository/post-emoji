 ...
 */
class DecoratorServicePass implements \Emoji\Vendor\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    public function process(\Emoji\Vendor\Symfony\Component\DependencyInjection\ContainerBuilder $container)
    {
        ...
        foreach ($definitions as list($id, $definition)) {
            ...
            if ($container->hasAlias($inner)) {
                ...
                $container->setAlias($renamedId, new \Emoji\Vendor\Symfony\Component\DependencyInjection\Alias($container->normalizeId($alias), \false));
            } else {
