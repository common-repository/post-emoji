...
class ServiceReferenceGraph
{
    ...
    public function getNode($id)
    {
        if (!isset($this->nodes[$id])) {
            throw new \Emoji\Vendor\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException(\sprintf('There is no node with id "%s".', $id));
        }
    ...
    public function connect($sourceId, $sourceValue, $destId, $destValue = null, $reference = null)
    {
        ...
        $edge = new \Emoji\Vendor\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphEdge($sourceNode, $destNode, $reference, $lazy, $weak, $byConstructor);
    ...
    private function createNode($id, $value)
    {
        ...
        return $this->nodes[$id] = new \Emoji\Vendor\Symfony\Component\DependencyInjection\Compiler\ServiceReferenceGraphNode($id, $value);
    }
}
