 ...
 */
class AutowireExceptionPass implements \Emoji\Vendor\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface
{
    private $autowirePass;
    private $inlineServicePass;
    public function __construct(\Emoji\Vendor\Symfony\Component\DependencyInjection\Compiler\AutowirePass $autowirePass, \Emoji\Vendor\Symfony\Component\DependencyInjection\Compiler\InlineServiceDefinitionsPass $inlineServicePass)
    {
    ...
    private function doesServiceExistInTheContainer($serviceId, \Emoji\Vendor\Symfony\Component\DependencyInjection\ContainerBuilder $container, array $inlinedIds)
    {
