...
abstract class AbstractServiceConfigurator extends \Emoji\Vendor\Symfony\Component\DependencyInjection\Loader\Configurator\AbstractConfigurator
{
    protected $parent;
    protected $id;
    private $defaultTags = [];
    public function __construct(\Emoji\Vendor\Symfony\Component\DependencyInjection\Loader\Configurator\ServicesConfigurator $parent, \Emoji\Vendor\Symfony\Component\DependencyInjection\Definition $definition, $id = null, array $defaultTags = [])
    {
        $this->parent = $parent;
