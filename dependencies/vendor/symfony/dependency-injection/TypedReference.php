 ...
 */
class TypedReference extends \Emoji\Vendor\Symfony\Component\DependencyInjection\Reference
{
    private $type;
     ...
     */
    public function __construct($id, $type, $requiringClass = '', $invalidBehavior = \Emoji\Vendor\Symfony\Component\DependencyInjection\ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE)
    {
