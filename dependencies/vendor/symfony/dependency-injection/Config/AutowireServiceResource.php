...
use Emoji\Vendor\Symfony\Component\Config\Resource\SelfCheckingResourceInterface;
use Emoji\Vendor\Symfony\Component\DependencyInjection\Compiler\AutowirePass;
/**
 * @deprecated since version 3.3, to be removed in 4.0. Use ContainerBuilder::getReflectionClass() instead.
 */
class AutowireServiceResource implements \Emoji\Vendor\Symfony\Component\Config\Resource\SelfCheckingResourceInterface, \Serializable
{
    private $class;
    private $filePath;
    ...
    public function isFresh($timestamp)
    {
        ...
        return (array) $this === (array) \Emoji\Vendor\Symfony\Component\DependencyInjection\Compiler\AutowirePass::createResourceForClass($reflectionClass);
    }
